...
Luego, almacena la respuesta en una variable y 
...
Luego, realiza la resta de estos dos valores y almacena el 
...
/*
9. Utiliza un bucle while para 
mostrar los números del 1 al 10 en la consola.
*/
let resultado = 1;
while (resultado < 11) {
...
muestra ese número en la consola.
*/
let numeroAleMenor = Math.floor(Math.random() * 10) + 1
console.log(numeroAleMenor)

/*
13. Utiliza Math.random para generar un número entero entre 1 y 1000 y 
muestra ese número en la consola.
*/
let numeroAleMayor = Math.floor(Math.random() * 1000) + 1
console.log(numeroAleMayor)
